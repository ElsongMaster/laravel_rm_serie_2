<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="{{asset('img/img1.jpg')}}" style = "height:400px; width:600px"class="d-block" alt="...">
    </div>
    <div class="carousel-item">
      <img src="{{asset('img/img2.jpg')}}" style = "height:400px; width:600px"class="d-block" alt="...">
    </div>
    <div class="carousel-item">
